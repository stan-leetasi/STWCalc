...
{
    EXPECT_STREQ("5", caleng_send_digit(eng, '5').to_display);
    EXPECT_STREQ("54", caleng_send_digit(eng, '4').to_display);
    EXPECT_STREQ("0", caleng_cancel(eng).to_display);
    EXPECT_STREQ("3", caleng_send_digit(eng, '3').to_display);
}

TEST_F(EngineTest, caleng_backspace)
{
    EXPECT_STREQ("0", caleng_backspace(eng).to_display);
    EXPECT_STREQ("1", caleng_send_digit(eng, '1').to_display);
    EXPECT_STREQ("12", caleng_send_digit(eng, '2').to_display);
    EXPECT_STREQ("120", caleng_send_digit(eng, '0').to_display);
...
TEST_F(EngineTest, caleng_send_digit)
{
    EXPECT_STREQ("1", caleng_send_digit(eng, '1').to_display);
    EXPECT_STREQ("12", caleng_send_digit(eng, '2').to_display);
    EXPECT_STREQ("120", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("1200", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("12009", caleng_send_digit(eng, '9').to_display);

    EXPECT_STREQ("0", caleng_cancel(eng).to_display);
    EXPECT_STREQ("", eng->input_buffer);
    EXPECT_STREQ("0", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("0", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("0", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("1", caleng_send_digit(eng, '1').to_display);
    EXPECT_STREQ("10", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("100", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("1000", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("10000", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("100000", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("1000000", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("10000009", caleng_send_digit(eng, '9').to_display);
    EXPECT_STREQ("100000099", caleng_send_digit(eng, '9').to_display);
    EXPECT_STREQ("100000099", caleng_send_digit(eng, '8').to_display);
    EXPECT_STREQ("100000099", caleng_send_digit(eng, '0').to_display);
...
TEST_F(EngineTest, caleng_insert_exp)
{
    ...
    EXPECT_STREQ("1e0", caleng_insert_exp(eng).to_display);
    EXPECT_STREQ("1e2", caleng_send_digit(eng, '2').to_display);
    EXPECT_STREQ("1e28", caleng_send_digit(eng, '8').to_display);
    EXPECT_STREQ("1e28", caleng_send_digit(eng, '8').to_display);
    EXPECT_STREQ("1e28", caleng_insert_exp(eng).to_display);
    caleng_cancel(eng);
    caleng_send_digit(eng, '4');
...
TEST_F(EngineTest, caleng_negate)
{
    ...
    EXPECT_STREQ("0", caleng_backspace(eng).to_display);
    EXPECT_STREQ("", eng->input_buffer);
    EXPECT_STREQ("7", caleng_send_digit(eng, '7').to_display);
    EXPECT_STREQ("-7", caleng_negate(eng).to_display);
    EXPECT_STREQ("-77", caleng_send_digit(eng, '7').to_display);
    EXPECT_STREQ("77", caleng_negate(eng).to_display);
    EXPECT_STREQ("775", caleng_send_digit(eng, '5').to_display);
    EXPECT_STREQ("775.", caleng_insert_decimal_point(eng).to_display);
    EXPECT_STREQ("-775.", caleng_negate(eng).to_display);
    EXPECT_STREQ("-775.1", caleng_send_digit(eng, '1').to_display);
    ...
    EXPECT_STREQ("-775.1e4", caleng_send_digit(eng, '4').to_display);
    EXPECT_STREQ("-775.1e40", caleng_send_digit(eng, '0').to_display);
    EXPECT_STREQ("-775.1e-40", caleng_negate(eng).to_display);
    EXPECT_STREQ("-775.1e40", caleng_negate(eng).to_display);
    EXPECT_STREQ("-775.1e40", caleng_send_digit(eng, '2').to_display);
}
...
TEST_F(EngineTest, caleng_select_bi_op)
{
    ...
    EXPECT_STREQ("-22", caleng_send_digit(eng, '2').to_display);
